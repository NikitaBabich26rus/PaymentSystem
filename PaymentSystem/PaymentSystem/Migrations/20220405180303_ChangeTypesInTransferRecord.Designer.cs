...
namespace PaymentSystem.Migrations
{
    ...
    [Migration("20220405180303_ChangeTypesInTransferRecord")]
    partial class ChangeTypesInTransferRecord
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaymentSystem.Data.UserRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "admin",
                            Password = "admin1234",
                            RegisteredAt = new DateTime(2022, 4, 5, 18, 3, 3, 239, DateTimeKind.Utc).AddTicks(5807)
                        });
                });
            ...
            modelBuilder.Entity("PaymentSystem.Data.VerificationRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PaymentSystem.Data.VerificationRecord", b =>
                {
                    ...
                    b.HasOne("PaymentSystem.Data.UserRecord", "User")
                        ...
                        .HasForeignKey("PaymentSystem.Data.VerificationRecord", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
